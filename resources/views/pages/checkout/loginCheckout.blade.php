...
<div class="container">
    <div class="d-flex justify-content-center h-100">
        <div class="card">
            ...
            <div class="card-body">
                <form id="login-form" class="form" action="{{route('Checkout.postlogincheckout')}}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        <input style="width: 110px" type="submit" value="Đăng nhập" class="btn float-right login_btn">
                    </div>
            ...
            <div class="card-footer">
                <div class="d-flex justify-content-center links">
                    Bạn có thể đăng ký tài khoản?<a href="{{route('Checkout.signup')}}">Đăng ký</a>
                </div>
