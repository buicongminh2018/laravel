    ...
    <div class="d-flex justify-content-center h-100">
        <div class="card">
            <div class="card-header">
                <h3>Đăng nhập</h3>
                <h5 style="color: #0DB7EA; text-align: center;">
                    <?php
            ...
            <div class="card-body">
                <form id="login-form" class="form" action="{{route('HomeController.postupdatePassword')}}" method="post">
                    @csrf
                    ...
                    <div class="input-group form-group">
                        ...
                        <input type="password"
                               ...
                               class="form-control" required placeholder="Nhập mật khẩu của bạn">
                    </div>
                    <div class="input-group form-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                    ...
                    <div class="input-group form-group">
                        ...
                        <input type="password"
                               name="customer_password_news"
                               class="form-control" required placeholder="Nhập lại khẩu mới">
                    </div>
                    <div class="row align-items-center remember">
                        <input type="checkbox" name="remember_me">Ghi nhớ đăng nhập
                    </div>
                    <div class="form-group">
                        <input style="width: 130px" type="submit" value="Đổi mặt khẩu" class="btn float-right login_btn">
                    </div>
            ...
            <div class="card-footer">
                <div class="d-flex justify-content-center links">
                    Bạn có thể đăng nhập ?<a href="{{route('HomeController.login')}}">Đăng nhập</a>
                </div>
                <div class="d-flex justify-content-center">
                    <a href="{{route('MailController.forget_password')}}s">Quên mặt khẩu</a>
