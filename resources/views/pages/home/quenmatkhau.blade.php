...
<div class="container">
    <div class="d-flex justify-content-center h-100">
        <div class="card">
            ...
            <div class="card-body">
                <form id="login-form" class="form" action="{{route('MailController.send_forget_password')}}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        <input style="width: 110px" type="submit" value="Gửi" class="btn float-right login_btn">
                    </div>
